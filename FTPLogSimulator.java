...
public class FTPLogSimulator {
    static  Logger logger=Logger.getLogger(String.valueOf(FTPLogSimulator.class));
    public static void main(String[] args) {
        try {
            ...
            logger.log(Level.INFO,"Format for arguments should be \n" +
                    "1. logcount\n2. fromDate(YYYY-MM-DD)\n3. toDate(YYYY-MM-DD)\n4. fromHour\n5. toHour\n6. textToFind(Optional)\n7. textToReplace(Optional)");
        }

    }

    static void ftpLogSimulator(int logCount, String fromDate, String toDate, int minHour, int maxHour) throws DateTimeParseException, FileNotFoundException {
        ftpLogSimulator(logCount, fromDate, toDate, minHour, maxHour, "", "");
    }

    static void ftpLogSimulator(int logCount, String fromDateText, String toDateText, int minHour, int maxHour, String textToFind, String textToReplace) throws DateTimeParseException, FileNotFoundException {
